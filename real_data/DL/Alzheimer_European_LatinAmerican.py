...
def get_data(file, seed=0):
    ...
    train, test = train_test_split(df, test_size=0.2, random_state=0, shuffle=True, stratify=df['YR'])
...
def run_cv(seed=0):
    ...
    para_naive = {'batch_size': 32, 'momentum': 0.9, 'n_epochs': epoch,
                  ...
                  'L1_reg': 0.001, 'L2_reg': 0.001, 'hidden_layers_sizes': [200]}
    para_super = {'batch_size': 32, 'momentum': 0.9, 'n_epochs': 50, 'tune_batch': 50,
                  'learning_rate': 0.2, 'lr_decay': 0.005, 'dropout': 0.5, 'tune_lr': 0.20, 'tune_epochs': 200,
                  'L1_reg': 0.0, 'L2_reg': 0.001, 'hidden_layers_sizes': [200]}

    Aggr, EA, Minor = get_data("data/AD/EA_Hispanic1.csv", seed=seed)
