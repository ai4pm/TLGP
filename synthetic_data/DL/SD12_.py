...
def mixture_learning(Aggr, minor='AFR', **kwds):
...
def get_data(file, seed=0):
    ...
    EAA_X_train, EAA_Y_train = X_train[R_train == 'AFR'], Y_train[R_train == 'AFR']
    EA_X_val, EA_Y_val = X_val[R_val == 'EUR'], Y_val[R_val == 'EUR']
    EAA_X_val, EAA_Y_val = X_val[R_val == 'AFR'], Y_val[R_val == 'AFR']
    EA_X_test, EA_Y_test = X_test[R_test == 'EUR'], Y_test[R_test == 'EUR']
    EAA_X_test, EAA_Y_test = X_test[R_test == 'AFR'], Y_test[R_test == 'AFR']
...
def run_cv(seed):
    ...
    Aggr, EA, Minor = get_data("../SD12.mat", seed=seed)
